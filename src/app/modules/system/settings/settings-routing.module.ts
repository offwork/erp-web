...
export const SystemSettingsRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'list', component: SettingListComponent, data: { title: 'List' }, },
      { path: 'create', component: SettingDetailComponent, data: { title: 'Create' },
        children: [
      ...
      },
      {
        ...
        resolve: { systemSetting: SettingResolver,},
        data: { title: 'setting' },
        children: [
          { path: '', redirectTo: 'edit', pathMatch: 'full' },
          { path: 'edit', component: SettingFormComponent, data: { title: 'Edit' }, },
        ],
      },
    ],
  },
