...
const routes: Routes = [
  { path: '', data: { title: 'Posts' },
    children: [
      { path: '', redirectTo: 'list', pathMatch: 'full' },
      { path: 'list', component: PostListComponent, data: { title: 'List' }, },
      { path: 'create', component: PostDetailComponent, data: { title: 'Create' },
        children: [
      ...
      { path: ':id', component: PostDetailComponent,
        ...
        children: [
          ...
          { path: 'edit', component: PostFormComponent, data: { title: 'Edit' }, },
        ],
      },
    ],
  },
