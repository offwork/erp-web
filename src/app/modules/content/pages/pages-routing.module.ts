...
const routes: Routes = [
  { path: '', data: { title: 'Pages' }, 
    children: [
      { path: '', redirectTo: 'list', pathMatch: 'full' },
      { path: 'list', component: PageListComponent, data: { title: 'List' }, },
      { path: 'create', component: PageDetailComponent, data: { title: 'Create' },
        children: [
          { path: '', component: PageFormComponent, },
        ],
      },
      { path: ':id', component: PageDetailComponent,
        resolve: { page: PagesResolver, },
        data: { title: 'page' },
        children: [
          { path: '', redirectTo: 'edit', pathMatch: 'full' },
          { path: 'edit', component: PageFormComponent, data: { title: 'Edit' }, },
        ],
      },
    ],
  },
