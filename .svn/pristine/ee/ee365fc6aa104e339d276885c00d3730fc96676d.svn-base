...
export const SystemDomainsRoutes: Routes = [
  { path: '', data: { title: 'Domains' },
    children: [
      { path: '', redirectTo: 'list', pathMatch: 'full' },
      { path: 'list', component: DomainListComponent, data: { title: 'List' }, },
      { path: 'create', component: DomainDetailComponent, data: { title: 'Create' },
        children: [
          { path: '', component: DomainFormComponent,},
        ],
      },
      {
        path: ':id',
        component: DomainDetailComponent,
        resolve: {systemDomain: DomainResolver,},
        data: { title: 'domain' },
        children: [
          { path: '', redirectTo: 'edit', pathMatch: 'full' },
          { path: 'edit', component: DomainFormComponent,data: { title: 'Edit' }, },
        ],
      },
    ],
  },
